...
interface GPIOSysVInterface
{
     ...
     * @access 	public
     */
    public function flashBinary(int $value, array $pin_array, int $select_pin, ?int $high_delay = 50000, ?int $low_delay = 50000, ?bool $blocking=false, ?string &$error_code=null) : ?bool;
     ...
     * @access 	public
     */
    public function strobeBinary(int $value, array $pin_array, int $select_pin, ?int $count=1, ?int $off_count=1, ?int $period=1000000, ?bool $blocking=false, ?string &$error_code=null) : ?bool;
